...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder="shaziaanwar")
    ...
    with btnc1:
        if st.button('Login ⌘ + Enter', icon=':material/passkey:' , width='stretch'):
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter Username", placeholder="shaziaanwar")
    teacher_name = st.text_input("Enter Name", placeholder="Shazia Anwar")
    teacher_pass = st.text_input("Enter Password", type='password', placeholder="Enter password")
    ...
    with btnc1:
        if st.button('Register now ⌘ + Enter', icon=':material/passkey:', width='stretch'):
